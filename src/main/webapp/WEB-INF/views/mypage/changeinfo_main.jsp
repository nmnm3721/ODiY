		...
		<!-- 프로필 사진 변경 -->
			...
			<form>
				<div class="form-group input-id">
					...
					<div>
						<input type="email" class="form-control" placeholder="문자를 입력하세요"
							aria-describedby="emailHelp">
					</div>
					<small id="emailHelp" class="form-text text-muted"> <font
						color="#0067a3"> 5~20자의 영문 소문자,숫자와 특수기호(_),(-)만 사용가능합니다.</font>
					</small>
					<!--**아이디 끝-->
				</div>
				<div class="form-group input-pw">
					<!--비밀번호 시작-->
					<label for="inputPassword5">비밀번호</label> <input type="password"
						id="inputPassword5" class="form-control"
						aria-describedby="passwordHelpBlock" placeholder="비밀번호를 정해주세요">
					<small id="passwordHelpBlock" class="form-text text-muted">
						<font color="#0067a3"> 4~16자 영문 대 소문자,숫자,특수문자를 사용하세요. </font>
					</small>
					<!--**비밀번호 끝-->
				</div>
				<div class="form-group input-pw2">
					<!--비밀번호 재확인 시작-->
					<label for="inputPassword5">비밀번호 재확인</label> <input type="password"
						id="inputPassword5" class="form-control"
						aria-describedby="passwordHelpBlock" placeholder="정한 비밀번호를 입력하세요">
					<small id="passwordHelpBlock" class="form-text text-muted">
						<font color="#0067a3"> 비밀번호가 일치하지 않습니다.</font>
					</small>
					<!--**비밀번호 재확인 끝-->
				</div>
				<div class="form-group input-name">
					...
					<small id="passwordHelpBlock" class="form-text text-muted">
						<font color="#0067a3"> 5~20자의 영문 소문자,숫자와 특수기호(_),(-)만
							사용가능합니다.</font>
					</small>
					<!--**이름 끝-->
				</div>
				...
				<div class="form-row input-birth">
					<div class="col-3 ">
						<label for="validationCustom03">년</label> <input type="text"
							class="form-control" id="validationCustom03" required>
						<div class="invalid-feedback">Please provide a valid city.</div>
					</div>
					<div class="col-6 ">
						<label for="validationCustom04">월</label> <select
					...
					<div class="col-3 ">
						<label for="validationCustom05">일</label> <input type="text"
				...
				<div class="form-group input-seibetu">
					...
					<form class="seibetu">
						...
						<select class="custom-select my-3 mr-sm-2 seibetu2 id="inlineFormCustomSelectPref">
							<option selected>성별을 바꾸셨습니까?</option>
				...
				<div class="form-group input-email">
					...
					<p>
						<small id="passwordHelpBlock" class="form-text text-muted">
							<font color="#0067a3"> 인증번호를 입력해주세요</font>
						</small>
					</p>
					<a class="complete" href="${pageContext.request.contextPath}/login/login.do"><button type="button" id="ok"
							class="btn btn-primary btn-lg btn-block">정보 변경</button></a>
				</div>
			</form>
		</div>
	</div>
