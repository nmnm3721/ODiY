...
<title>ODiY - Offers, Destinations, in your mind_Search</title>
...
<link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/search_main.css" type="text/css" />
<!-- FontAwesome -->
...
<body>
	...
	<%@ include file="search_main_2.jsp"%>
